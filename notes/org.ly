...
BassFigures = \figuremode {
  ...
  r %70
  \bo <[6]>4 \bc <[_+]>2.
  r2 r8 \bo <[5 3]> \bassFigureExtendersOn <5 3> q \bassFigureExtendersOff
  <6 4>4 \bc <[5 _+]>2.
  r1
  \bo <[5-]>2 <7->4 <6>8 \bc <[5]> %75
  r1
  \bo <[_+ \l]>2 <6>4 <_+>
  <_->1
  <6>2 <5>4 <6>
  r4. <7>8 <6 4>4 \bc <[5 3]> %80
  r1
  r
  r
  r2 <[5-]>
  ...
  r
  r2. <[7]>4
  r8 \bo <[5+ _+]> <5 3>2 \bassFigureExtendersOn <5 3>8 q \bassFigureExtendersOff %95
  <6 4>4 <5+ _+>2.
  r4 <6> <_+>2
  <6 5>4 <_+>8 <\t> <6>4 <6\\>
  <_+>2 <6>
  ...
  r <_+>4 <6>
  r2 <[_!]>
  r r8 \bo <[5 3]>4 \bassFigureExtendersOn <5 3>8 \bassFigureExtendersOff %135
  <6 4>4 \bc <[5 _+]>2.
  r1
  r2 <[6]>
  r1
  ...
  \bo <[7]>4 <6> \bc <[5+] _+>2
  r2 <[6+ 4+ 2+]> %180
  r r8 \bo <[5+ _+]> \bc <[5+ \l]>4
  r1
  \bo <[6 \l]>4 <6>8 <5> <_+>2
  <6> <3>8 <4+> <6>4
  <7> <6 5>8 \bc <[7 _+]> r2 %185
  ...
  r <5+>4 \bc <[6 \l]>
  <[5+] _+>1 %270
  \bo <[5+ \l]>2 r8 <8 _+>4 \bassFigureExtendersOn <8 _+>8 \bassFigureExtendersOff
  <6 4+>4 <5+ _+> <5+>2
  <_+>2 <6>4 <_+>8 <6>
  r4. <6\\>8 <6>4. <_+>8
  ...
  <_!>2 <6>
  r \bc <[5-]>
  r8 \bo <[8 3]>4 \bassFigureExtendersOn <8 3>8 \bassFigureExtendersOff <6 4>4 \bc <[5 _+]>
  r1 %300
  <[6]>
  r
  r
  ...
  <\t \t>4 <5- 3> <7->2
  <5- 3> q4 \bc <[5- 3]>
  \bo <[7- 6 4-]> \bassFigureExtendersOn <7- 5 3>8 <7- 4- 2> <7- 5 3>2 \bassFigureExtendersOff
  <5- 3>1 %340
  <6>
  r2 <6->
  r1
  ...
  r
  \bo <[6 5]>2 <9>4 \bc <[8 \l]>
  \bo <[8 6 _-]>4. \bassFigureExtendersOn <7 5 _->8 \bassFigureExtendersOff <5 _+>4 \bc <[6 4 \l]>
  \bo <[4]> \bc <[_+]>2.
  r1 %390
  r2 <[_+]>
  r1
  ...
  <6>1
  <6+>
  <6>4 \bo <[_- \l]> <6 4> \bc <[5 _+]> %555
  r1
  r2 <[4+] 2>
  <_+>1
  <[6]>
  \bo <[6 5 _+]>4 <7 5+ _+>2. %560
  <6>2 <6 4>4 \bc <[5+ _+ \l]>
  r1
  <[6]>
  r
  ...
  r2 <_-> %630
  r1
  r8 <7- 5> \bassFigureExtendersOn <7- 5> \bassFigureExtendersOff <6 5> <4>4 \bc <[_! \l]>
  r1 %633 FINIS
}
...
BassFiguresCoro = \figuremode {
  ...
  r1
  r1*70 %317
  r2 r8 \bo <[6 \l]>4 \bassFigureExtendersOn <6>8 \bassFigureExtendersOff
  <6 4>4 <5 3>2.
  r2. <7->4 %320
  r2 <5->
  r <4- 2>4 \bc <[6 5-]>
